...
def test_for_number_not_divided_by_three():
    assert is_divisable_by_three(2) == False

def test_for_number_divided_by_five():
    assert is_divisable_by_five(5) == True

def test_for_number_not_divided_by_five():
    assert is_divisable_by_five(2) == False

def test_for_number_divided_by_fifteen():
    assert is_divisable_by_fifteen(15) == True

def test_for_number_not_divided_by_fifteen():
    assert is_divisable_by_fifteen(2) == False
